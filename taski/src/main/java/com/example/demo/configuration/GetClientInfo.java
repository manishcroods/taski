...
public class GetClientInfo
{
	...
	public ClientInfo printClientInfo(HttpServletRequest request ) 
	{
       
        ci.setReferer(getReferer(request));
        ci.setFillURL(getFullURL(request));
        ci.setClientIpAddr(getClientIpAddr(request));
        ci.setClientOS(getClientOS(request));
        ci.setClientBrowser(getClientBrowser(request));
	...
	/*
	 * public String getUser(HttpSession session) { return
