...
<body>
	...
	<div class="navbar navbar-expand-md navbar-dark">
		...
		<div class="navbar-brand">
			<a href="/contacts" class="d-inline-block">
				<img src="<%=request.getContextPath()%>/global_assets/images/logo_light.png" alt="">
			</a>
		</div>
	...
	<!-- Users slide bar -->
						...
						<li class="nav-item nav-item-submenu">
							<a href="/user" class="nav-link"><i class="icon-stack"></i> <span>Users</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Starter kit">
								<li class="nav-item"><a href="/saveuser" class="nav-link">Add new User</a></li>
