					...
					<div
						...
						<div class="dropdown-content-header">
							<span class="font-weight-semibold">Users online</span> <a
								href="#" class="text-default"><i class="icon-search4 font-size-base"></i></a>
						</div>
					...
					<div class="d-flex">
						<div class="breadcrumb">
							...
							" class="breadcrumb-item"><i
								...
								class="breadcrumb-item active">Contacts</span>
						</div>
					...
					<div class="card-body">
						...
						<form action="/addcontacts" method="post">
								...
								<div class="form-group">
									...
									<input type="hidden" name="contactsId" value=${contact.contactsId }>
							
									<div class="form-group">
										<div class="form-label-group">
											<input type="text" id="contactname" name="contactName" class="form-control"
												value="${contact.contactName}" required="required" autofocus="autofocus" >
										</div>
									</div>
									<div class="form-group">
										<div class="form-label-group">
												<input type="text" id="inputEmail" name="email" class="form-control"
												value="${contact.email}" required="required" autofocus="autofocus" >
										</div>
									</div>
									<div class="form-group">
										<div class="form-label-group">
											<input type="text" id="mobile" name="mobile" class="form-control"
												value="${contact.mobile}" required="required" autofocus="autofocus" >
										</div>
									</div>
